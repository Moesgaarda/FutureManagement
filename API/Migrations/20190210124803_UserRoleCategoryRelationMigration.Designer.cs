...
namespace API.Migrations
{
    ...
    [Migration("20190210124803_UserRoleCategoryRelationMigration")]
    partial class UserRoleCategoryRelationMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Models.UserRoleCategoryRelation", b =>
                {
                    b.Property<int>("UserId");

                    b.Property<int>("RoleCategoryId");

                    b.HasKey("UserId", "RoleCategoryId");

                    b.HasIndex("RoleCategoryId");

                    b.ToTable("UserRoleCategoryRelations");
                });
            ...
            modelBuilder.Entity("API.Models.UserRoleCategoryRelation", b =>
                {
                    b.HasOne("API.Models.RoleCategory", "RoleCategory")
                        .WithMany("UserRoleCategoryRelations")
                        .HasForeignKey("RoleCategoryId")
                        .OnDelete(DeleteBehavior.Cascade);
